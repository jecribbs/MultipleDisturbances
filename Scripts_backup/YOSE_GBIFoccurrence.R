...
setwd("/Users/jennifercribbs/Documents/YOSE/Analysis/MultipleDisturbances/dataSandbox/CleanData")
...
# Read in spatial table with occurrence ID and lat long then join
