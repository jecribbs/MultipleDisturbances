...
eventData <- combinedData %>% rename(eventID = plotID, 
  ...
  mutate(parentEventID = "NA", 
         sampleSizeValue = trans_length * width, 
         ...
         coordinateUncertaintyinMeters = "NA", # maybe add GPS field uncertainty with metadata notes 
         coordinatePrecision = "NA", # this may be a feature of the GPS units
         publicDisplay = "yes",
